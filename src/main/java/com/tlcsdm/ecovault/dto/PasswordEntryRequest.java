...
public record PasswordEntryRequest(@NotBlank(message = "标题不能为空") @Size(max = 128, message = "标题过长") String title,
		...
		@Size(max = 128, message = "账号过长") String account,

		@NotBlank(message = "密码不能为空") String secret,

		@Size(max = 256, message = "站点地址过长") String url,

		String notes,

		@Size(max = 64, message = "分类过长") String category,

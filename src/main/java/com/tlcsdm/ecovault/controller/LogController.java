...
@RequestParam(required = false) @DateTimeFormat(pattern = DateTimeConfig.DATE_TIME_PATTERN) LocalDateTime start,
@RequestParam(required = false) @DateTimeFormat(pattern = DateTimeConfig.DATE_TIME_PATTERN) LocalDateTime end,

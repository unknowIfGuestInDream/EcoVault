...
public class LogController {
    ...
    public ResponseEntity<byte[]> export(@RequestParam(required = false) String module,
        ...
        for (OperationLog log : logs) {
            sb.append(log.getCreatedAt() == null ? "" : FORMATTER.format(log.getCreatedAt())).append(',')
                    .append(nullToEmpty(log.getUsername())).append(',')
                    .append(nullToEmpty(log.getModule())).append(',')
                    .append(nullToEmpty(log.getOperation())).append(',')
                    .append(nullToEmpty(log.getMethod())).append(',')
                    .append(nullToEmpty(log.getIp())).append(',')
                    .append(nullToEmpty(log.getStatus())).append(',')
